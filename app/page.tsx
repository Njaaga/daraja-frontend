      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <header className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/signup"
              className="rounded-full bg-blue-600 text-white px-5 py-2 text-sm font-medium hover:bg-blue-600/90 transition"
            >
              Get Started
            </a>
          </div>
        ...
        <main className="mt-20 grid gap-12 lg:grid-cols-2">
          ...
          <section className="space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <a
                href="/signup"
                className="rounded-full bg-blue-600 text-white px-8 py-3 font-semibold hover:bg-blue-600/90 transition"
              >
                Start Reporting
              </a>
              <a
